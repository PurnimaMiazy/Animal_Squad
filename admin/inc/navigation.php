              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=care and disease" class="nav-link nav-care">
                        <i class="nav-icon fas fa-box"></i>
                        <p>
                           Pet Care and Disease
                        </p>
                      </a>
                    </li>
                    <li class="nav-item dropdown">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=maintenance/care_category" class="nav-link nav-maintenance/care_category">
                        <i class="nav-icon fas fa-th-list"></i>
                        <p>
                          Pet care and disease category list
                        </p>
                      </a>
                    </li>
                    
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=maintenance/care_sub_category" class="nav-link nav-maintenance/care_sub_category">
                        <i class="nav-icon fas fa-th-list"></i>
                        <p>
                          Pet care and disease sub category list
                        </p>
                      </a>
                    </li>
                    <li class="nav-item dropdown">
